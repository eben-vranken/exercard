...
const ConfirmModal: React.FC<ConfirmModalProps> = ({ title, description, onClose }) => {
    return (
        <section className="absolute top-1/2 left-1/2 w-1/4 flex flex-col gap-y-6 h-min bg-background border border-white/10 rounded p-3 transform -translate-x-1/2 -translate-y-1/2">
            <section>
